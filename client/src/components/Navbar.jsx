        ...
        <div className="flex items-center font-medium justify-around">
            <div className="z-50 p-5 md:w-auto w-full flex justify-between">
                <div className="dropdown w-max">
                    ...
                    {address && (
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[2] p-2 shadow bg-base-100 rounded-box w-max">
                        <div className='w-[50px] h-[50px] flex justify-start items-center cursor-pointer'>
                ...
                <Link to="/" className='text-3xl font-bold cursor-pointer'>
                        Vote<span style={{ color: '#8C35FF' }}>Now</span>
                </Link>
            </div>
